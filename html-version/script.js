...
// CV Upload Form Handler (for file upload version)
const cvUploadFormFile = document.getElementById("cv-upload-form");
if (cvUploadFormFile && document.getElementById("cv-file")) {
  ...
  cvUploadFormFile.addEventListener("submit", async (e) => {
    e.preventDefault();
    
    const formData = new FormData(cvUploadFormFile);
    ...
    cvUploadFormFile.style.display = "none";
    if (successMessage) {
      successMessage.style.display = "block";
    }

    // TODO: In production, implement actual file upload to your server
    // Example:
...
// Language switching (currently hidden)
...
const applyLanguage = (lang) => {
  ...
  document.querySelectorAll("[data-lang-en]").forEach(el => {
    ...
    const fiText = el.getAttribute("data-lang-fi");
  ...
  document.querySelectorAll(".lang-pill").forEach(pill => {
    const pillLang = pill.textContent.trim().toLowerCase();
...
// Old CV form handler removed - now using file upload version above
